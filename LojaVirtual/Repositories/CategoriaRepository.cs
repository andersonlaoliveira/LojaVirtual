...
namespace LojaVirtual.Repositories
{
    public class CategoriaRepository : ICategoriaRepository
    {
        ...
        public IEnumerable<Categoria> ObterCategoriasRecursiva(Categoria categoriaPai)
        {
            if(Categorias == null)
            {
                Categorias = ObterTodosOsCategorias().ToList();
            }
            ...
            if (ListaCategoriaFilho.Count() > 0)
            {
                ...
                {
                    ObterCategoriasRecursiva(categoria);
                }
            }
